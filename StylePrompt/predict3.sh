CUDA_VISIBLE_DEVICES=3 python predict.py \
    ...
    --test_data_path ../data/Java_programming/java_programming_test_part/Java_programming_test_part3.json \
    --predict_dirs  ../out_predict/style_promot_MSA_all_BqI_part3.json 
