CUDA_VISIBLE_DEVICES=2 python predict.py \
    ...
    --test_data_path ../data/Java_programming/java_programming_test_part/Java_programming_test_part2.json \
    --predict_dirs  ../out_predict/style_promot_MSA_all_BqI_part2.json  
