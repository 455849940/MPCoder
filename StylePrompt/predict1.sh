CUDA_VISIBLE_DEVICES=1 python predict.py \
   ...
   --train_data_path ../data/Java_programming/Java_programming_train.json \
    ...
    --test_data_path ../data/Java_programming/java_programming_test_part/Java_programming_test_part1.json \
    --predict_dirs  ../out_predict/style_promot_MSA_all_BqI_part1.json 
